...
namespace EMS.BuyStock
{
    public partial class frmBuyStock : Form
    {
        ...
        {
            EMS.SelectDataDialog.frmSelectUnits selectUnits;//声明frmSelectUnits窗体对象
            selectUnits = new EMS.SelectDataDialog.frmSelectUnits();//初始化frmSelectUnits窗体对象
        ...
        {
            SelectDataDialog.frmSelectStock selectStock = new EMS.SelectDataDialog.frmSelectStock();//创建frmSelectStock窗体对象
